...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @stableflow/sdk

# or
yarn add @stableflow/sdk
pnpm add @stableflow/sdk`,
  },
  {
    label: "Connect",
    code: `import { StableFlow } from '@stableflow/sdk'

const sf = new StableFlow({
  chain: 'base',
...
const features = [
  ...
  { 
    title: "Base L2 optimized", 
    description: "Sub-second finality, near-zero gas."
  },
  { 
    title: "EVM compatible", 
    description: "Works on Base, Ethereum, Arbitrum, and more."
  },
  { 
    title: "8KB gzipped", 
    description: "Minimal footprint, zero bloat."
  },
];
