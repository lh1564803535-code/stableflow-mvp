...
const features = [
  {
    ...
    description: "Every transaction is secured by smart contract escrow. Funds are released only when both parties confirm delivery. No trust required.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "On-Chain Reputation",
    description: "Build verifiable reputation through completed transactions. Every rating is immutably recorded on-chain. Sybil-resistant by design.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Multi-Stablecoin Support",
    description: "Accept and pay in USDC, USDT, DAI and more. Automatic conversion at market rates. One wallet, every stablecoin.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Instant Settlement",
    description: "Built on Base L2 for sub-second finality and near-zero gas fees. Your transactions settle before you can refresh the page.",
    visual: "deploy",
  },
];
