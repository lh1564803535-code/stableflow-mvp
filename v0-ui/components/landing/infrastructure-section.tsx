...
const locations = [
  { city: "Base", region: "L2 — Ethereum", latency: "0.5s" },
  { city: "Ethereum", region: "L1 — Settlement", latency: "12s" },
  { city: "Arbitrum", region: "L2 — Ethereum", latency: "0.3s" },
  { city: "Optimism", region: "L2 — Ethereum", latency: "0.4s" },
  { city: "Polygon", region: "L2 — Ethereum", latency: "2s" },
  { city: "Avalanche", region: "L1 — C-Chain", latency: "1s" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              Deploy once, run everywhere. Our edge network spans 6 data centers 
            ...
            <div className="grid grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">On-chain uptime</div>
              </div>
              <div>
          ...
          >
            <div className="border border-foreground/10">
              ...
              <div className="px-6 py-4 border-b border-foreground/10 flex items-center justify-between">
                <span className="text-sm font-mono text-muted-foreground">Supported Networks</span>
