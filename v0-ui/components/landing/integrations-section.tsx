...
const integrations = [
  ...
  { name: "Coinbase", category: "Wallet" },
  { name: "USDC", category: "Stablecoin" },
  { name: "USDT", category: "Stablecoin" },
  { name: "Base", category: "L2 Network" },
  { name: "Ethereum", category: "L1 Network" },
  { name: "The Graph", category: "Stablecoin" },
  { name: "Chainlink", category: "Oracle" },
  { name: "IPFS", category: "Storage" },
  { name: "Wagmi", category: "Dev Kit" },
  { name: "Viem", category: "Dev Kit" },
  { name: "Foundry", category: "Dev Tools" },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            Deep integrations with the web3 ecosystem.
          </p>
        </div>
