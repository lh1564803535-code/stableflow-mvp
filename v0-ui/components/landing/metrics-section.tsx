...
const metrics = [
  { 
    value: 2438912, suffix: "", prefix: "$", label: "Total value locked",
  },
  { 
    value: 99, suffix: ".99%", prefix: "", label: "Uptime (smart contracts)",
  },
  { 
    value: 47000, suffix: "+", prefix: "", label: "Transactions completed",
  },
  { 
    value: 142, suffix: "", prefix: "", label: "Countries served",
  },
];
