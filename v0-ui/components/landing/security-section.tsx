...
const securityFeatures = [
  {
    ...
    description: "All escrow contracts audited by leading firms. Open-source, verified on-chain.",
  },
  {
    icon: Lock,
    title: "Non-Custodial",
    description: "Your keys, your funds. We never hold or have access to your assets.",
  },
  {
    icon: Eye,
    title: "Transparent by Default",
    description: "Every transaction is publicly verifiable on-chain. Full audit trail, zero opacity.",
  },
  {
    icon: FileCheck,
    title: "On-Chain Arbitration",
    description: "Disputes resolved by decentralized arbitration. Fair outcomes, enforced by code.",
  },
];

const certifications = ["Solidity", "OpenZeppelin", "Base L2", "Etherscan Verified", "Multi-sig"];
